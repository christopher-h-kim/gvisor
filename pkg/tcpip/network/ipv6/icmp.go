...
func (e *endpoint) handleICMP(r *stack.Route, netHeader buffer.View, vv buffer.VectorisedView) {
	...
	case header.ICMPv6NeighborSolicit:
		...
		if err := r.WritePacket(nil /* gso */, hdr, buffer.VectorisedView{}, header.ICMPv6ProtocolNumber, r.DefaultTTL(), 0); err != nil {
	...
	case header.ICMPv6EchoRequest:
		...
		if err := r.WritePacket(nil /* gso */, hdr, vv, header.ICMPv6ProtocolNumber, r.DefaultTTL(), 0); err != nil {
			sent.Dropped.Increment()
			return
		}
